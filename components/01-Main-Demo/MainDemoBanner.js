...
import img from "../../public/images/vidya/home01.png";
            ...
            <div className="content">
              <div className="inner">
                ...
                <p className="description">
                  Gain practical skills through hands-on learning and{" "}
                  <strong>expert guidance</strong> to excel in your career.
                </p>
                ...
                <div className="slider-btn">
                  ...
                  >
                    <span className="icon-reverse-wrapper">
                      <span className="btn-text">View All Course's</span>
