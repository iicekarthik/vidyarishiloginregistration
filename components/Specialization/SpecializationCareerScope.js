...
const SpecializationCareerScope = ({ CourseDetails, specialization }) => {
  const careerData = [
    {
      ...
      >
        <div className="d-flex justify-content-start gap-2 mb-4">
          <h5 className="mb-2">
            ...
            {specialization.specialization_name} Course Career Scope
          </h5>
        </div>
        ...
        <div style={{ padding: "0px 20px", color: "black" }}>
          <div className="d-flex justify-content-center flex-column mb-5 ">
            <h5>
              ...
              >
                {specialization?.career_scope?.subCareerScope?.heading}
              </ReactMarkdown>
            </h5>
            {specialization?.career_scope?.subCareerScope?.desc?.map(
              (items, index) => (
                <div
                  key={index}
                  style={{
          ...
          <div className="d-flex justify-content-center flex-column  ">
            <DynamicCourseTable
              ...
              data={specialization?.career_scope?.subCareerScope?.careerPoints}
          ...
          <div className="d-flex justify-content-center flex-column my-5 ">
            <h5>
              ...
              >
                {
                  specialization?.career_scope?.subCareerScope?.careerPointsTwo
                    ?.heading
                }
              </ReactMarkdown>
            </h5>
...
export default SpecializationCareerScope;
