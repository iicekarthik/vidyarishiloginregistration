...
const SpecializationTop = ({ CourseDetails, slugcourses, specialization }) => {
          ...
          >
            ...
            >
              <span>
                ...
                >
                  {specialization?.aboutSpecializationDesc}
                </ReactMarkdown>
              </span>
            </div>
...
export default SpecializationTop;
