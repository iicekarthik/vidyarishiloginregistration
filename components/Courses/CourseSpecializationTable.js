...
const CourseSpecializationTable = ({
  headers = [],
  data = [],
                    ...
                    >
                      {row.specialization_link ? (
                        <Link
                          ...
                          target="_blank"
                          href={`/course/${slugcourses}/${row?.specialization_link}`}
                        >
                          {row?.title || row?.specialization_name}
                          <FaExternalLinkAlt
...
export default CourseSpecializationTable;
