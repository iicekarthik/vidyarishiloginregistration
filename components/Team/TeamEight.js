    ...
    <>
      <div className="container">
        ...
        {head === undefined ? (
          <TeamHead
            isTheme={"theme2"}
            subTitle="👋 Say Goodbye to Anonymous Call Centers"
            title="Expert Guidance "
            Jointtitle={"You Can Trust"}
            desc={[
              "Our team of 500+ experienced professionals has been supporting you since 2019, ensuring you receive the best advice for a successful career journey.",
            ]}
          />
        ) : (
          ""
        ...
        <div className="row row--15">
          <div className="col-lg-12">
            ...
            >
              {TeamData &&
                TeamData.teamVidyarishi.slice(0, 4).map((data, index) => (
