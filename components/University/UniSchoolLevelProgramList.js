...
const UniSchoolLevelProgramList = ({ university, screenSize, slug }) => {
    ...
    return (
        <>
            <div
                id="UniversitySchoolLevelProgram"
            ...
            >
                ...
                <div className="d-flex justify-content-start gap-2 mb-4">
                    ...
                    >
                        All School Level Program Of {university?.title}
                    </h5>
                </div>
                    ...
                    >
                        ...
                        >
                            {(() => {
                                ...
                                const SchoolLevelProgramTypes = [
                                    ...new Set(
                                        university?.schoollevelprogram?.map((course) => course?.degree_name)
                                    ),
                                ];

                                return SchoolLevelProgramTypes?.map((degreeType) => {

                                    const filteredCourses = university?.schoollevelprogram
                                    ...
                                    return (
                                        ...
                                        >
                                            <thead>
                                                ...
                                                <tr>
                                                    {[
                                                        { IconName: "book", HeaderName: "Programs" },
                                                        {
                                                            IconName: "rupee",
                                                            HeaderName: university?.isAnnualFee
                                                                ? "Program Fee"
                                                                : "Semester Fee",
                                                        },
                                                        {
...
export default UniSchoolLevelProgramList;
