...
const UniSpecializationTop = ({
  ...
  // console.log("SpecializationDetails - ", specializationDetails);
          ...
          <div style={{ flex: "1", minWidth: "60%" }}>
            <h2 style={{ margin: 0, textAlign: "left", lineHeight: "1" }}>
              <span style={{ color: "purple" }}>
                ...
                {` In ${specializationDetails?.specialization_name} `}
              </span>{" "}
              <Link
            ...
            >
              <span>
                ...
                >
                  {specializationDetails?.aboutSpecializationDesc}
                </ReactMarkdown>
              </span>
            </div>
...
export default UniSpecializationTop;
