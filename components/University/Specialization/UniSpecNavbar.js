...
const UniSpecializationNavbar = ({ university }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = [
        ...
        "SpecializationSpecializations",
        "SpecializationSyallabus",
        "SpecializationTopUniversities",
      ...
      >
        ...
        >
          {[
            ...
            { NavName: "Top Universities", NavLink: "CourseTopUniversities" },
...
export default UniSpecializationNavbar;
