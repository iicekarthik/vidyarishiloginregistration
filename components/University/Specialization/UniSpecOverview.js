...
const UniSpecializationOverview = ({
  CourseDetails,
      ...
      >
        <div className="d-flex justify-content-start gap-2">
          <h5 className="p--0 m--0">
            ...
            {specializationDetails.specialization_name} Overview
          </h5>
        </div>

        <div style={{ padding: "0px 20px", color: "black", fontSize: "16px" }}>
          {specializationDetails?.overview?.overviewDetails?.map(
            (items, index) => (
              <div
                key={index}
          ...
          <div className="d-flex justify-content-left align-items-left ">
            <DynamicCourseTable
              ...
              data={specializationDetails?.keyoverview}
...
export default UniSpecializationOverview;
