...
const UniSchoolLevelProgramEligibilityDuration = ({ CourseDetails }) => {
  return (
    <>
      <div
        id="SchoolLevelProgramEligibilityDuration"
        style={{
          // background: "yellow",
          textAlign: "justify",
        }}
      ...
      >
        <div className="d-flex justify-content-start gap-2">
          ...
          >
            {CourseDetails?.course_type} {CourseDetails?.shortName} School Level Program
...
export default UniSchoolLevelProgramEligibilityDuration;
