...
const FAQ = ({ university, BigScreenLogic }) => {
  return (
    <div
      id="UniversityFAQ"
      className="px-5 pt--60"
      style={{ paddingBottom: `${BigScreenLogic ? "0px" : "80px"}` }}
    >
      {/* <div>
        <h5 >
          FAQ Of <span style={{ color: "purple" }}> {university?.title}</span>{" "}
        </h5>
      </div> */}

      <div className="d-flex justify-content-start gap-2">
        <h5 className="mb-2">
          FAQ's | Frequently Asked Questions Of {university?.title}
        </h5>
      </div>

      <div className="rbt-accordion-area accordion-style-1 bg-color-white mt-4 mb-5">
        <div className="container">
          {university?.faq?.map((data, index) => (
