...
const UniversitySubnav = ({ university }) => {
  const [isSticky, setIsSticky] = useState(false);
  const [activeSection, setActiveSection] = useState(""); // Active section track karega
    ...
    const handleScroll = () => {
      ...
      const sections = [
        ...
        university.hasSchoolLevelProgram ?
          "UniversitySchoolLevelProgram" :
          "UniversityCourse",
        "UniversityApprovals",
        "UniversityEmi",
        "UniversityManagementSpecialization",
        "UniversityEligibilityCriteria",
        "UniversityHiringPartners",
        "UniversityAdvantages",
        "UniversitySampleCertificate",
        "UniversityExamPattern",
        "UniversityAdmissionProcess",
        "UniversityFaculty",
        "UniversityOtherUniversities",
        // "UniversityBlog",
        "UniversityFAQ",
      ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {[
            { NavName: "About", NavLink: "UniversityAbout" },
            { NavName: "Approvals", NavLink: "UniversityApprovals" },
            { NavName: `${university.hasSchoolLevelProgram ? "School Level Program " : "Courses"}`, NavLink: `${university.hasSchoolLevelProgram ? "UniversitySchoolLevelProgram" : "UniversityCourse"}` },
            { NavName: "Emi Available", NavLink: "UniversityEmi" },
            {
              NavName: "Sample Certificate",
              NavLink: "UniversitySampleCertificate",
            },
            { NavName: "Advantages", NavLink: "UniversityAdvantages" },
            { NavName: "Exam Pattern", NavLink: "UniversityExamPattern" },
            { NavName: "Hiring Partners", NavLink: "UniversityHiringPartners" },
            {
              NavName: "Admission Process",
              NavLink: "UniversityAdmissionProcess",
            },
            {
              NavName: "Other Universities",
              NavLink: "UniversityOtherUniversities",
            },
            // { NavName: "Blog", NavLink: "UniversityBlog" },
            { NavName: "FAQ", NavLink: "UniversityFAQ" },
          ].map((items, index) => (
            <li
              key={index}
              style={{
...
export default UniversitySubnav;
